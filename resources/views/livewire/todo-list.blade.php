            ...
            <div class="col-span-3 mx-3 my-10">
                <div class="rounded-xl bg-zinc-400 shadow shadow-white px-4 py-6">
                    @if ($todo->status === 'afgerond')
                        ...
                        @else
                        <div class="flex justify-end">
                            <svg wire:click='markAsDone({{ $todo->id }})' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-12 h-12 hover:text-emerald-800 transition-all text-emerald-700 hover:cursor-pointer">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div>
                        <div class="flex items-center justify-center mt-20">
                            ...
                            <div class="flex flex-col justify-center items-center w-full">
                                <label for=""
                                    class='flex w-full items-center justify-center font-bold uppercase px-4 py-4 mt-5 rounded border-gray-900 @if ($todo->status === 'openstaand') bg-red-700 @else bg-emerald-700 @endif text-gray-300'>{{ $todo->status }}</label>
                            </div>
